...
<body>
	<s:if test="hasActionErrors()">
		<span style="color: red; text-align: center;"><s:property
				value="error" />
			<s:actionerror /> </span>
	</s:if>
	<div>
		...
		<div class="gh-log">
			<span class="gh-lg"><a href="dummy" rel="nofollow">
					<img src="buyitnow/logoEbay_x45.gif" alt="eBay" border="0"> </a>
			</span>
		</div>
		<span></span>
		<div class="gh-cl"></div>
			...
			<tbody>
				<tr>
					<td><s:form name="makePayment" autocomplete="OFF"
							action="makePayment" method="post" id="SSPMformID" theme="simple"
														...
														<tr>
															<td><div class="cr-hr">
																	<div class="itemsumstyle">
																		<b>Review the items you are buying and your order
																			total</b>
																	</div>
																</div>
															</td>
																					...
																					class="g-hdn">Member id</b><span class="mbg-nw"><s:property
																							value="seller_name" />
																									...
																									<div class="single-item-summ-body-qty">
																										<div class="controls">
																											<s:textfield
																												name="items[%{#stats.index}].selectedQuantity"
																												value="%{selectedQuantity}" size="2"
																												width="2"
																												placeholder="Enter quantity of product, you would like to purchase"
																												onblur="fnNumeric(this)"
																												onsubmit="fnNumeric(this)" />
																										</div>
																									</div>
																									<div class="stDiv">
																											...
																											<tbody>
																												<tr>
																													<td class="symDivTd"><div
																															class="symDiv">Rs.</div></td>
																													<td class="priceDivTd"><div
																															class="priceDiv" id="regsubtotal">
																															<s:property value="item_subTotal" />
																														</div>
																													</td>
																												</tr>
																											</tbody>
														...
														<div style="color: #333333">
															<div class="cr-w">
																<div class="cr-hr">
																	<div>
																		<b><div>
																				<br> <span>Your shipping address</span>
																			</div> </b>
																	</div>
																</div>
																<br>
																	...
																	<div style="height: 150px; padding-left: 5px">
																		<div>
																			...
																			<div class="g-std" id="addrrow1">
																				...
																				<div id="addrrow"></div>
																				<div id="addrrow">
																					<span><s:property value="userCity" /> </span>
																				</div>
																				<div id="addrrow">
																					<span><s:property value="userState" /> </span>
																				</div>
																				<div id="addrrow">
																					<span><s:property value="userCountry" /> </span>
																				</div>
																			</div>
																	...
																	<div class="cr-w">
																		<div class="cr-hr">
																			...
																			<div class="shipmethod">
																				<span><b>Order Total and Shipping Charges</b>
																				</span>
																			</div>
																		</div>
																		<div class="cr-cnt">
																			...
																			target="_blank">click here.</a> </span>
																						...
																						<div class="ps-ppButton">
																							<s:radio label="paymentmode" name="paymentmode"
																								list="#{'1':'Credit Card','2':'Debit Card','3':'Net Banking'}"
																								value="1" />
																							&nbsp;
																							<s:select name="banks" label="Net Banking"
																								...
																								<div class="cr-cnt">
																									<div style="white-space: nowrap;">
																										<img src="buyitnow/icoPasiaPay_GXO_110311.gif"
																											...
																											color="#333333">PaisaPay sends your
																											money to the seller</font>
																										<div
																											style="padding-left: 43px; margin-top: -5px; color: #333333">
																											<font color="#333333">after you get
																												the item</font>
																										</div>
																										<br> <img
																										...
																										<br> <img
																											...
																											alt="" class="ps-bImg" height="25" width="25"><font
																											color="#333333">Replacement or Refund
																											if you are not</font>
																										<div
																											style="padding-left: 43px; margin-top: -5px; color: #333333">
							...
							<div>
								<div class="btnMsgBar">
									<span style="vertical-align: middle;"><b id="continue"
										class="btn-w btn-m btn-p"><span id="spn_continue"
											class="btn-b moz btn-b pbn-P"><s:submit
													id="but_continue" name="continue" value="continue"
													class="btn btn-danger" onclick="return CheckingMode();" />
										</span> </b> </span>&nbsp;&nbsp;<span class="msg">You will confirm the
