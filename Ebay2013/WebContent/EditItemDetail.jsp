...
<td>Name</td><td><s:textfield name="item_name" label = "Name "  value="%{item.item_name}"/></td></tr>
  ...
  <tr><td>Offer</td><td><s:select name="offer" list="#{'Yes':'Yes','No':'No'}" headerKey="" headerValue="Select" required="true"  placeholder="Select Yes if you want to give offer"/></td> </tr>
